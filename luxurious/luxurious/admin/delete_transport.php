					...
					<div id="content1">
					  <table  height="150" width="0"> </table>
						...
						<?php
								...
								if(isset($_POST['transport_del'])&&isset($_POST['trans_no_del']))
								   {
									  $transport_del = $_POST['transport_del'];
									  $trans_no_del = $_POST['trans_no_del'];
									
									  $query = mysql_query("select * from transport_cost_list WHERE  Name='$transport_del' and Trans_No=$trans_no_del  ");
										 if( ! (mysql_num_rows($query)  ) )
										      die(" The TRANSPORT NUMBER OR NAME  IS CONFLICTED ,YOU HAVE TO GO BACK        <----------- ");
										 else
									  $delete_selected = mysql_query("delete from transport_cost_list WHERE  Name='$transport_del' and Trans_No=$trans_no_del ");
								   }
                        ?>

                              <h4 align="center"> DELETE  TRANSPORT   , GO TO UPDATE PACKAGES PAGE 
