		...
		<div id="page1">
				<div id="page1-bg-top">
					...
					<table  height="100" width="0"> </table>
						<table align="center">
							<form name = "formcp" action = "changepassword.php" method = "post">
								<tr>
									<td>Previous Password:</td>
								</tr>
								<tr>
									<td><input name = "prvpassword" type = "password" size=20 /></td>
								</tr>
								<tr>
									<td>New Password:</td>
								</tr>
								<tr>
									<td><input name = "newpassword" type = "password" size=20 /></td>
								</tr>
								<tr>
