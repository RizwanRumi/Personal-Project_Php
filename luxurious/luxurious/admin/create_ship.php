					  ...
					  <table  height="150" width="0"> </table>
                             ...
                             <?php
						            ...
						            mysql_select_db("u148570980_tour");
									    ...
									    if(isset($_POST['ship_name'])&&isset($_POST['ship_classic'])&&isset($_POST['ship_m_luxury'])&&isset($_POST['ship_luxury'])) 
									      {
											$ship = $_POST['ship_name'];
											$classic_ship = $_POST['ship_classic'];
											$m_luxury_ship = $_POST['ship_m_luxury'];
											$luxury_ship = $_POST['ship_luxury'];
															
											$query = mysql_query("select * from ship_cost_list WHERE Name = '$ship'  ");
									    	if (  mysql_num_rows($query) >0   )       die(" THE SHIP NAME  IS CONFLICTED ,YOU HAVE TO GO BACK        <----------- ");
											else
											    $insert = mysql_query("insert into ship_cost_list values('$ship','$classic_ship','$m_luxury_ship','$luxury_ship') ");
										  }
														
                             ?>
								

                              <h4 align="center"> CREATE NEW SHIP LIST SUCCESSFULLY , GO TO UPDATE PACKAGES PAGE 
