					  ...
					  <table  height="150" width="0"> </table>
						...
						<?php
						    ...
						    mysql_select_db("u148570980_tour");
							  ...
							  if(isset($_POST['ship_name_upd'])&&isset($_POST['classic_ship_upd'])&&isset($_POST['m_luxury_ship_upd'])&&isset($_POST['luxury_ship_upd'])) 
							    {
									$ship = $_POST['ship_name_upd'];
									$classic_ship = $_POST['classic_ship_upd'];
									$m_luxury_ship = $_POST['m_luxury_ship_upd'];
									$luxury_ship = $_POST['luxury_ship_upd'];
									
									$query = mysql_query("select * from ship_cost_list WHERE Name = '$ship'  ");
									  if( ! (mysql_num_rows($query)  ) )        die(" THE SHIP NAME  IS CONFLICTED ,YOU HAVE TO GO BACK        <----------- ");
									  else
									  $update = mysql_query("update ship_cost_list set Classic='$classic_ship',M_luxurious='$m_luxury_ship',Luxurious='$luxury_ship' WHERE Name='$ship' ");
						        }
                        ?>

                              <h4 align="center"> UPDATE SHIP LIST SUCCESSFULLY , GO TO UPDATE PACKAGES PAGE 
