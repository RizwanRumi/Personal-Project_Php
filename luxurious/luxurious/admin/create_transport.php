					...
					<div id="content1">
					  <table  height="150" width="0"> </table>
						...
						<?php
							...
							if(isset($_POST['trans_no'])&&isset($_POST['transport'])&&isset($_POST['classic'])&&isset($_POST['luxury'])&&isset($_POST['place'])) 
							   {
								    ...
								    $query = mysql_query("select * from transport_cost_list WHERE  Trans_No = $trans_no ");
									if(mysql_num_rows($query)> 0)     die(" The TRANSPORT NUMBER  IS CONFLICTED ,YOU HAVE TO GO BACK        <----------- ");
									else
										$insert = mysql_query("insert into transport_cost_list values($trans_no,'$transport','$classic','$luxury','$place')");
							   }
                        ?>

                              <h4 align="center"> CREATE NEW TRANSPORT , GO TO UPDATE PACKAGES PAGE 
