					...
					<div id="content1">
					  <table  height="150" width="0"> </table>
						...
						<?php
							...
							if(isset($_POST['ship_del']))
				               {
									$ship_del = $_POST['ship_del'];
											
									$query = mysql_query("select * from ship_cost_list WHERE Name = '$ship_del'  ");
									
									if( ! (mysql_num_rows($query)  ) )  die(" THE SHIP NAME  IS CONFLICTED ,YOU HAVE TO GO BACK        <----------- ");
									 else
									$delete_ship = mysql_query("delete from ship_cost_list WHERE  Name='$ship_del' ");
							   }	
                        ?>

                              <h4 align="center"> DELETE SHIP LIST SUCCESSFULLY , GO TO UPDATE PACKAGES PAGE 
